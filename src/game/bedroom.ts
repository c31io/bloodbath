...
export const BEDROOM = {
  ...
  phone: { anchor: { x: 0.7, y: 0.65, z: 1 }, model: { file: "phone", pos: [0.7, 0.75, 1.15], size: 0.16, solid: [[-0.04, 0, -0.01, 0.04, 0.16, 0.01]] } },
  ...
  laptop: { anchor: { x: -2.4, y: 0.78, z: -1.5 }, model: { file: "computer", pos: [-2.4, 0.72, -1.5], size: 0.5, solid: [[-0.14, 0, -0.07, 0.14, 0.5, 0.07]] } },
