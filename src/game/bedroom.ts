...
export const BEDROOM = {
  ...
  bed: { anchor: { x: 2.2, y: 0.95, z: 0.4 }, model: { file: "bed-double", pos: [2.1, 0, 0.4], size: 2.1, rotY: HALF_PI } },
  sleeper: { anchor: { x: 2.2, y: 0.95, z: 0.4 }, model: { file: "man-a", pos: [2.15, 0.58, 0.4], size: 1.75, rotY: HALF_PI, rotZ: HALF_PI } },
  cat: { anchor: { x: -1.5, y: 0.12, z: 1.5 }, model: { file: "cat-a", pos: [-1.5, 0, 1.5], size: 0.55 } },
  nightstand: { anchor: { x: 2.55, y: 0, z: -1.85 }, model: { file: "night-stand", pos: [2.55, 0, -1.85], size: 0.75 } },
  lamp: { anchor: { x: 2.55, y: 1.3, z: -2.0 }, model: { file: "light-desk", pos: [2.55, 0.74, -1.95], size: 0.45 } },
  phone: { anchor: { x: 0.7, y: 0.65, z: 1.0 }, model: { file: "phone", pos: [0.7, 0.75, 1.15], size: 0.16 } },
  desk: { anchor: { x: -2.4, y: 0.78, z: -1.5 }, model: { file: "desk", pos: [-2.4, 0, -1.3], size: 1.25 } },
  laptop: { anchor: { x: -2.4, y: 0.78, z: -1.5 }, model: { file: "computer", pos: [-2.4, 0.72, -1.5], size: 0.5 } },
  vaseSpot: { anchor: { x: 2.55, y: 1.05, z: -1.6 }, model: { file: "chalice", pos: [2.55, 0.74, -1.55], size: 0.26 } },
  bowlSpot: { anchor: { x: -0.8, y: 0.06, z: 1.9 }, model: { file: "bowl", pos: [-0.8, 0, 1.9], size: 0.24 } },
  drainSpot: { anchor: { x: -2.85, y: 0.03, z: 0.6 }, model: undefined },
  pottedPlant: { anchor: { x: -2.6, y: 0.35, z: -2.0 }, model: { file: "plant-big", pos: [-2.6, 0, -2.0], size: 0.95 } },
  windowsillPlant: { anchor: { x: 0, y: 1.4, z: -2.4 }, model: { file: "plant", pos: [0, 1.43, -2.42], size: 0.45 } },
